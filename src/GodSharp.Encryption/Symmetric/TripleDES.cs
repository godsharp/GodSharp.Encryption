...
namespace GodSharp.Encryption
{
    ...
    public class TripleDES : SymmetricBase<TripleDESCryptoServiceProvider>
    {
        ...
        public static string Encrypt(string data, string password, string vector = null, string salt = null, TripleDESKeySizeFlags keySize = TripleDESKeySizeFlags.L192, Encoding encoding = null, int iterations = 1000, CipherMode mode = CipherMode.ECB, PaddingMode padding = PaddingMode.PKCS7)
        {
        ...
        public static string Decrypt(string data, string password, string vector = null, string salt = null, TripleDESKeySizeFlags keySize = TripleDESKeySizeFlags.L192, Encoding encoding = null, int iterations = 1000, CipherMode mode = CipherMode.ECB, PaddingMode padding = PaddingMode.PKCS7)
        {
        ...
        public static byte[] EncryptBytes(string data, string password, string vector = null, string salt = null, TripleDESKeySizeFlags keySize = TripleDESKeySizeFlags.L192, Encoding encoding = null, int iterations = 1000, CipherMode mode = CipherMode.ECB, PaddingMode padding = PaddingMode.PKCS7)
        {
        ...
        public static byte[] DecryptBytes(string data, string password, string vector = null, string salt = null, TripleDESKeySizeFlags keySize = TripleDESKeySizeFlags.L192, Encoding encoding = null, int iterations = 1000, CipherMode mode = CipherMode.ECB, PaddingMode padding = PaddingMode.PKCS7)
        {
